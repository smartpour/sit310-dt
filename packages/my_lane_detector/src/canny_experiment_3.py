...
# Define your Canny thresholds for Experiment 3
low_threshold = 120
high_threshold = 240 # Example: Another 1:2 ratio, but higher overall
...
try:
    while True:
        ...
        cv2.imshow(f"Canny Edges (Exp 3: Low={low_threshold}, High={high_threshold})", edges)
