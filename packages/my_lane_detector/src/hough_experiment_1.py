...
canny_image_filename = 'canny_output_low75_high150.png' # Example - CHANGE THIS
...
hough_threshold_value = 50 # First threshold value for Hough
...
maxLineGap = 10    # Maximum allowed gap between line segments to treat them as a single line. # Corrected parameter name
# ----------------------
...
def run_hough_transform(original_img_path, canny_img_path, hough_threshold, rho, theta, minLineLength, maxLineGap, param_name, param_value):
    ...
    # Corrected parameter name from maxGap to maxLineGap
